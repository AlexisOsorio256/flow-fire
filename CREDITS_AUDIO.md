...
Sonidos reales con licencia **Creative Commons 0 (CC0)**, descargados de Freesound.org, recortados y normalizados con ffmpeg para este proyecto.
...
- `shot_6.wav`: "S&W M&P9 Shield: one round fired at night (no processing)" por AnthonyChan0 — https://freesound.org/s/703342/ — CC0 (Freesound).
